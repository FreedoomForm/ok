...
export default function TamboRuntime({ apiKey, children }: TamboRuntimeProps) {
  ...
  return (
    <TamboProvider
      ...
      tools={tools}
      contextHelpers={{ current_time: currentTimeContextHelper }}
      initialMessages={[
        {
          role: "system",
          content: [
