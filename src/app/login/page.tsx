    ...
    >
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center">
          <span className="auth-separator rounded-base border-2 border-border bg-background px-2 py-0.5 text-foreground">{uiText.or}</span>
        </div>
      </div>

      <Button type="button" variant="outline" className="auth-google-button h-10 w-full text-black dark:text-white" onClick={() => signIn('google', { callbackUrl: '/auth/redirect' })}>
