  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
 "bg-background text-foreground font-heading rounded-base text-[13px] flex items-center gap-2.5 p-4 w-[356px] [&:has(button)]:justify-between",
          description: "font-base",
          actionButton:
 "font-base text-[12px] h-6 px-2 bg-main text-main-foreground rounded-base shrink-0",
          cancelButton:
 "font-base text-[12px] h-6 px-2 bg-secondary-background text-foreground rounded-base shrink-0",
