...
export default function OfflinePage() {
 ...
 <section className="w-full max-w-md rounded-2xl bg-card p-6 text-center shadow-sm">
        ...
        <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:justify-center">
          <Link
            href="/"
 className="inline-flex items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent"
          >
            Open Home
          </Link>
          <Link
