...
export const translations = {
    ru: {
        ...
        admin: {
            ...
            pausedFilter: 'Приостановлены',
            middleAdmins: 'Средние администраторы',
            activeShort: 'активных',
            ordersObserved: 'Отслеживаемые заказы',
            pendingShort: 'в ожидании',
            deliverySuccess: 'Успех доставки',
            deliveredShort: 'доставлено',
            paymentMix: 'Оплата: карта / наличные',
    ...
    uz: {
        ...
        admin: {
            ...
            all: 'Barchasi',
            searchByNameEmail: 'Ism yoki email bo\u2018yicha qidirish',
            activeFilter: 'Faol',
            pausedFilter: 'To\u2018xtatilgan',
            middleAdmins: 'O\u2018rta administratorlar',
            activeShort: 'faol',
            ordersObserved: 'Kuzatiladigan buyurtmalar',
            pendingShort: 'kutilmoqda',
            deliverySuccess: 'Yetkazish muvaffaqiyati',
            deliveredShort: 'yetkazilgan',
            paymentMix: 'To\u2018lov: karta / naqd',
            cardCash: 'Karta / Naqd',
            chat: 'Chat',
            saving: 'Saqlanmoqda...',
